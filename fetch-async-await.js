...
async function fetchData(urlApi) { //siempre async antes de function
    const response = await fetch(urlApi); //hacemos uso del fetch() para conectar con la API
...
} // la finalidad de esta funcion es solo de obtener los datos de la API y transformarlos a JSON
