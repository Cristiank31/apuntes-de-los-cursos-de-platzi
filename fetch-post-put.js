...
const data = {
    "title": "Nunca pares de aprender y avanzar",
    "price": 2,
...
postData(`${API}/products`, data)
    ...
    //metodo put - actualizacion de datos de la API
    ...
    const dataUpdate = {
        ...
        "price": 1000,
         // no es necesario colocar todas las características del objeto, solo las que se cambiarán
    }
    
    putData(`${API}/products/232`, dataUpdate) //se debe colocar el id del objeto que se quiere modificar
        .then(response => response.json())
